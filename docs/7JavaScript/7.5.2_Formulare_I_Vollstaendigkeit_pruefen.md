...
<body>
  ...
  <form action="daten.html" onsubmit="return pruefung();">
    <fieldset style="text-align: right; width: 450px;">
      ...
      Postleitzahl: <input name="plz" type="text" size="5" maxlength="5"><br>
...
- Wir haben ein in HTML immer ein `document` im DOM-Baum.
...
Die Überprüfung unserer vier `<input>`-Elemente lautet damit:
